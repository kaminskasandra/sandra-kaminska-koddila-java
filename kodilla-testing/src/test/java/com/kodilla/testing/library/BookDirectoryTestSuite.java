...
public class BookDirectoryTestSuite {
    ...
    @Test
    void testListBooksInHandsOfNoBooksInHands() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "1234567890");
        List<Book> emptyBooksInHands = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(emptyBooksInHands);
    ...
    @Test
    void testListBooksInHandsOfOneBookInHands() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "1234567890");
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(booksInHands);
    ...
    @Test
    void testListBooksInHandsOfFiveBooksInHands() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "1234567890");
        List<Book> booksInHands = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(booksInHands);
